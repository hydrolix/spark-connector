...
class ColumnarJsonParsingComplexTest {
  ...
  private val complexSchemaCore = SparkTypes.sparkToCore(complexSchema).asInstanceOf[types.StructType]
  ...
  private val complexSchemaNoMapsCore = SparkTypes.sparkToCore(complexSchemaNoMaps).asInstanceOf[types.StructType]
